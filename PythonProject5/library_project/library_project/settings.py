...
SECRET_KEY = 'django-insecure-r^tiyl(=q1vs&n&l=&nbel!qk*6i=ttf*krku&alt^6g@em#rr'
...
LOGIN_REDIRECT_URL = 'profile' # Редирект после входа
LOGIN_URL = 'login' # вход
